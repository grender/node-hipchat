...
(function() {
  ...
  HipChatClient = (function() {
    ...
    HipChatClient.prototype.postNotification = function(params, callback) {
      var data, options, _ref, _ref1;
      data = {
        message: params.message,
        notify: params.notify ? 1 : 0,
        color: (_ref = params.color) != null ? _ref : 'yellow',
        message_format: (_ref1 = params.message_format) != null ? _ref1 : 'html'
      };
      options = this._prepareOptions({
        method: 'post',
